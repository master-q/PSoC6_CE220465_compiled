...
*
* Firmware initializes and starts the Crypto server. The server runs only on the
* CM0+ core, and works with the Crypto hardware. The Crypto server is implemented
* as a secure block. It performs all cryptographic operations for the client.
* Access to the server is through the Inter Process Communication (IPC) driver.
* Direct access is not allowed.
*
* The Crypto client can run on either core. Firmware initializes and starts the
* client. The firmware then provides the configuration data required for the
...
* </table>
*
* On the CM0+, the error, release, and notify interrupts are assigned to
* NVIC IRQn 28-30 respectively. Do not modify these values.
* See System Interrupt (SysInt) for background on CM0+ interrupts.
*
* \section group_crypto_server_init Server Initialization
*
* Use \ref Cy_Crypto_Server_Start. This call must be made from the CM0+ core only.
...
****************************************************************************//**
*
* This function copy memory block. It operates data in the user SRAM and doesn't
...
****************************************************************************//**
*
* This function sets the memory block. It operates data in the user SRAM and
...
****************************************************************************//**
*
* This function compares memory blocks. It operates data in the user SRAM and
* doesn't use Crypto internal SRAM.
*
* There is no alignment restriction.
* This function is independent from the previous Crypto state.
...
****************************************************************************//**
*
* This function calculate XOR of two memory blocks. It operates data in the user
...
*
* \param srcBlock
* The pointer to a source block. Must be 4-vyte aligned.
*
* \param dstBlock
* The pointer to a destination cipher block.
*
...
* integer values. To convert it from (to) binary (octet) strings use the \ref
* Cy_Crypto_Rsa_InvertEndianness function.
*
*
* \param pubKey
